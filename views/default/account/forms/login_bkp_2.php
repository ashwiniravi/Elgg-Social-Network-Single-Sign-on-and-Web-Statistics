...
$form_body .= elgg_view('input/submit', array('value' => elgg_echo('login'))) . "<br />" . elgg_view('input/submit', array('value' => elgg_echo('fbconnect'))) . "<div id=\"persistent_login\"><label><input type=\"checkbox\" name=\"persistent\" value=\"true\" />".elgg_echo('user:persistent')."</label></div></p>";
...
$form_body .= "<a href=\"{$vars['url']}account/fbconnect.php\" >" . elgg_echo('fbconnect') . "</a></p>";
